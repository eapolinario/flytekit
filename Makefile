...
dev-requirements.in: export CUSTOM_COMPILE_COMMAND := make dev-requirements.in
dev-requirements.in: dev-requirements.in requirements.txt install-piptools
	$(PIP_COMPILE) $<
...
.PHONY: requirements
requirements: requirements.txt dev-requirements.in requirements-spark2.txt doc-requirements.txt ${MOCK_FLYTE_REPO}/requirements.txt ## Compile requirements
